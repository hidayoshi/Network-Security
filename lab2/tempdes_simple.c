...
{
    int k;
    DES_LONG	in[2];                     //8-byte data for encryption (DES_LONG type is 4-byte size)
    ...
    str2DES_cblock(str_key, &des_key);     //Convert key from  string format to key in DES_cblock format 
